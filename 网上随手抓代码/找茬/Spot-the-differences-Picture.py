...
if hwnd == 0:
    ...
    rect1 = (game_rect[0] + int(92 * rate_width), game_rect[1] + int(312 * rate_height),
             game_rect[0] + width / 2 - int(37 * rate_width),
             game_rect[1] + +int(598 * rate_height))  # 沿中线分开，+55是因为去掉图像的左边沿
    rect2 = (game_rect[0] + width / 2 + int(37 * rate_width), game_rect[1] + +int(312 * rate_height),
             game_rect[2] - int(92 * rate_width), game_rect[1] + +int(598 * rate_height))  # 沿中线分开，-55是因为去掉图像的右边沿
    ima = ImageGrab.grab(rect1)
    imb = ImageGrab.grab(rect2)
    out = ImageChops.difference(ima, imb)  # 比较两幅图
    ima.save("D:/dowork/pyCharm/网上随手抓代码/找茬/test1.jpg", 'jpeg')
    imb.save("D:/dowork/pyCharm/网上随手抓代码/找茬/test2.jpg", 'jpeg')
    out.save("D:/dowork/pyCharm/网上随手抓代码/找茬/out.jpg", 'jpeg')

    img1 = cv2.imread("D:/dowork/pyCharm/网上随手抓代码/找茬/out.jpg")
    ...
    test1 = cv2.imread("D:/dowork/pyCharm/网上随手抓代码/找茬/test1.jpg")
    test2 = cv2.imread("D:/dowork/pyCharm/网上随手抓代码/找茬/test2.jpg")
    cv2.imshow('D:/dowork/pyCharm/网上随手抓代码/找茬/test1.jpg', test1)
    cv2.imshow('D:/dowork/pyCharm/网上随手抓代码/找茬/test2.jpg', test2)
